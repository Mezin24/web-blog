...
const SkeletonTemplate: ComponentStory<typeof ArticleListItemSkeleton> = (
  args
...
export const SkeletonSmall = SkeletonTemplate.bind({});
SkeletonSmall.args = {
  view: ArticleView.SMALL,
};

export const SkeletonBig = SkeletonTemplate.bind({});
SkeletonBig.args = {
  view: ArticleView.BIG,
};
